 ...
 <div class="container-fluid">
     ...
     <div class="card">
         <h5 class="card-header">
             <strong><?= $title; ?></strong>
             <a href="<?php echo base_url('sdm/cuti_lain_kaur'); ?>" class="btn btn-primary btn-sm float-right">Approval Cuti Lain</a>
         </h5>
         <div class="card-body">
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form action="<?php echo base_url('sdm/approve_cuti_kaur'); ?>" method="post">
 ...
 <script>
     $('.tombol-edit').on('click', function() {
         ...
         $.ajax({
             url: '<?php echo base_url('sdm/get_cuti_kaur'); ?>',
             data: {
                 id: id
             },
             method: 'post',
