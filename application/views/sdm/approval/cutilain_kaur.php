 ...
 <div class="container-fluid">
     ...
     <div class="card">
         <h5 class="card-header">
             <strong><?= $title; ?></strong>
             <a href="<?php echo base_url('sdm/cuti_kaur'); ?>" class="btn btn-primary btn-sm float-right">Approval Cuti Tahunan</a>
         </h5>
         <div class="card-body">
             <div class="table-responsive">
                 <table class="table table-hover" id="table-id">
                     ...
                     <tbody>
                         <?php $i = 1; ?>
                         <?php foreach ($staf_cuti_lain as $sc) : ?>
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form action="<?php echo base_url('sdm/approvecuti_lain_kaur'); ?>" method="post">
                     <div class="row">
                         <div class="col-md-6">
 ...
 <script>
     $('.tombol-edit').on('click', function() {
         ...
         $.ajax({
             url: '<?php echo base_url('sdm/get_cutilain_staf'); ?>',
             data: {
                 id: id
             },
             method: 'post',
